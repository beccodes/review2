...
let css = [
    ...
    "How do you add a comment in CSS? What’s the shortcut?",
    "/* comment here /. The shortcut is ctrl and /.",
    ...
    "Create a container element that will be the parent of the flex items. Set the display property of the container to flex to activate flexbox behavior. Define the flex direction of the container using the flex-direction property. Use the justify-content property to align the flex items along the main axis. This property controls the spacing between the items. Use the align-items property to align the flex items along the cross axis. This property controls the vertical alignment of the items. Use the flex-wrap property to control how flex items wrap to a new row or column when the container is not wide enough to display them all on one line. Use the flex property on individual flex items to control their individual sizing and behavior within the flexbox layout.",
    ...
    "How would you create a box behind a box using CSS?",
    ...
    "It’s a shorthand property that combines flex-direction and flex-wrap into one property.",
    ...
    "What is the flex property shorthand for?",
    ...
    "What pseudo-class selects and styles the element that currently has focus, such as an input field?",
    ":focus",
    "What pseudo-class selects and styles an element when the mouse hovers over it?",
    ":hover",
    "What pseudo-class selects a link that has been visited?",
    ":visited",
    "What pseudo-classes select the first and last child elements of a parent element?",
    ":first-child and :last-child",
    "What pseudo-class selects child elements based on a formula or expression, such as :nth-child(2) to select the second child element?",
    ":nth-child(). For example, .parent :nth-child(2n+1) would select all odd-numbered child elements of a parent class element, starting from the first child.",
    ...
    ":not()",
    "What pseudo-class selects and styles a checked input element, such as a checkbox or radio button?",
    ":checked",
    ...
    ":empty",
    "What pseudo-class selects and styles the element that is the target of the current URL, such as an anchor link?",
    ":target",
    "What pseudo-class selects elements based on their language attribute?",
    ":lang()",
    "What pseudo-class selects the root element of a document, typically the &lthtml&gt element",
    ":root",
    "What pseudo-classes select the first and last elements of a certain type within its parent element?",
